...
from copy import deepcopy                    #We use deepcopy to clone the original list. This is for pass by value
#--------------------K-Means Begins------------------------------------------------------------------------------------------------------------------------------
...
def K_Means (dataperson):
    ...
    check = False
    while check == False:
        k = int(input("Number of centroids: "))                                 #This variable determines the number of centroid we will use. It will be a constant.
        if k > ilen_dat2:
            print ("You can't put more centroids then there are points. Please try again.")     #A check to see if the user didn't enter more centroids then there are
                                                                                                #points.
        else:
            check = True
