...
import Columning_RGB                                #Importing Density rows ---> Columning function and color assignment for Density
from Infinite_Dimensional_Clustering_RGB import clustering      #Importing Density Clustering Algorithm and it's accompanying Anomaly Detection
...
while yes == True:                                                                                  #While Loop runs as long as yes is True
    try:
        ...
        if method==1:                   #Run Density and Anomaly clustering Algorithm
            option = 2
            Clusters = clustering (dataperson)      #Run Density-based Clustering
            d_cluster,color4,pl_colorscale2 = Columning_RGB.colcol (Clusters)     #Run Columning for color assignment and turning rows to columns.
            ...
            print ("Loading...")
            Graph (option,k,k_cluster,k_centroid,pl_colorscale,color3,color2,d_cluster,color4,pl_colorscale2)  #Run the Graph function to graph the results
