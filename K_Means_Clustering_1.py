...
def K_Means (dataperson):
    ...
    color_list = list(Cluster_2[len(Cluster_2) - 1])                      #Assign the last column to color_list
    color_list2 = list(centroid_list2[len(centroid_list2) - 1])
...
##    print ("")
##    print (Cluster_2)
    return k,Cluster_2,centroid_list2,pl_colorscale,color_list,color_list2
